...
class WebdockHostComplianceIntegrationTests(TestCase):
    def test_current_webdock_prohibited_workloads_fail_closed(self):
        cases = {
            ...
            "Perform an nmap port scan of the customer network": "PROHIBITED_NETWORK_SCANNING",
            ...
            "Host an LLM locally on the VPS": "PROHIBITED_LOCAL_NEURAL_RUNTIME",
            "Fine-tune a neural network locally on the server": "PROHIBITED_LOCAL_NEURAL_RUNTIME",
