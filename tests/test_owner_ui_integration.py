...
class OwnerUIIntegrationTests(TestCase):
    ...
    def test_public_root_is_plain_language_landing_page_without_owner_runtime_payload(self):
        ...
        self.assertContains(response, "Digital work chosen for")
        self.assertContains(response, "Profit-aware digital commerce")
        self.assertContains(response, "Cost before execution")
        self.assertContains(response, "QA before delivery")
        self.assertContains(response, "Settlement before revenue")
        self.assertContains(response, "One operating system")
        self.assertContains(response, "Several ways to earn")
        ...
        self.assertContains(response, "Profit-aware digital work, with owner control.")
        self.assertContains(response, "AMARKT<span>AI</span> EARN")
        ...
        self.assertNotContains(response, "fake revenue")
    ...
    def test_final_owner_ia_renders_and_legacy_system_routes_redirect_to_settings(self):
        ...
        self.assertContains(overview, ">Products<")
        self.assertContains(overview, ">Connections<")
        self.assertContains(overview, ">Workers<")
        self.assertContains(overview, ">Money<")
        self.assertContains(overview, ">Advanced<")
    ...
    def test_ui_assets_are_discoverable_and_preserve_settled_cash_language(self):
        ...
        self.assertIsNotNone(finders.find("control/brand-system.css"))
        ...
        self.assertIn("Only received payouts count as cash", app_script)
    ...
    def test_polling_and_market_value_labels_do_not_overclaim_runtime_or_currency(self):
        app_script = Path(finders.find("control/app.js")).read_text(encoding="utf-8")
        self.assertIn("What can earn, what is blocked, and what needs your attention.", app_script)
