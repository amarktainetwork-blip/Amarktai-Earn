...
_SPECS: tuple[WorkerSpec, ...] = (
    ...
    WorkerSpec(
        ...
        qa_profile="transcript",
        description="Bounded scanned-document OCR through dynamic off-host GenX vision with local deterministic PDF rasterization",
        input_suffixes=(".pdf", ".png", ".jpg", ".jpeg", ".webp", ".tif", ".tiff", ".bmp"),
        requires_genx=True,
        runtime_commands=("pdftoppm",),
        runtime_capability="offhost_scanned_document_ocr",
        provider_category="text",
        tool_requirements=("pdftoppm", "file_upload", "file_cleanup"),
