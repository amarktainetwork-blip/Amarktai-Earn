...
def overview_snapshot() -> dict:
    ...
    return {
        ...
        "cards": [
            ...
            {"label": paid_cost_label, "value": f"${_money(paid_execution_cost_30d)}", "truth": "recorded completed GenX monetary cost attributable to USD-settled jobs in the same window; incomplete coverage is labeled explicitly and no external cost is invented"},
            ...
            {"label": profit_7d_label, "value": f"${_money(truth_7d.net_settled_profit)}", "truth": "settled payout net less recorded attributable GenX monetary cost in the same window"},
            {"label": profit_30d_label, "value": f"${_money(recorded_net_profit_30d)}", "truth": "settled payout net less recorded attributable GenX monetary cost in the same window"},
