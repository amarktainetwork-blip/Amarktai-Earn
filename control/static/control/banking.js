(function () {
    ...
    return `<article class="rail-card" data-rail="${slug}">
      ...
      <details class="proof-editor">
        ...
        <form class="proof-form" data-proof-form="${slug}">
          ...
          <div class="proof-actions"><button type="submit">Save verified state</button></div>
        </form>
      </details>
    </article>`;
  }
  ...
  function render(data) {
    ...
    <div class="banking-truth"><strong>Truth rule:</strong> ${esc(meta.truth || "Payment and payout rail evidence remains fail-closed.")}</div>`;
