(function () {
  ...
  function renderMoney(data) {
    ...
    const settled = cardValue(overview.cards, "SETTLED 30D", "$0.00"); const pending = cardValue(overview.cards, "PENDING PAYOUT", "$0.00"); const cost = cardValue(overview.cards, "RECORDED GENX COST 30D", "$0.00"); const profit = cardValue(overview.cards, "RECORDED NET PROFIT 30D", "$0.00");
