...
def _two_sided_revenue_contracts(*, ci_proven: bool) -> list[AcceptanceCriterion]:
    definitions = (
        ...
        ("crypto_markets_absent", "Crypto revenue candidates are absent", "CI proved removed chain-market identifiers are absent from the revenue catalog while defensive host rejection remains.", (("control/services/autonomous_income_acceptance.py", "REMOVED_CRYPTO_MARKETS"), ("tests/test_webdock_host_compliance_integration.py", "test_all_onchain_candidates_are_absent_and_defensively_denied"))),
