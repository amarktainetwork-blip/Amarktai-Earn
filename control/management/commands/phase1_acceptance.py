...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        check(
            ...
            {
                "default": "unsupported unless worker explicitly opts in",
        ...
        check(
            "AUTONOMY_REMAINS_OFF_DURING_PHASE1",
            autonomy == "OFF",
            {"mode": autonomy},
        )
        ...
        report = {
            ...
            "note": "Dynamic success/failure/timeout/failover/interruption/idempotency cases are enforced by the Phase 1 CI test set; this command performs no paid or external mutation.",
        }
        ...
        if failures and options["fail_on"] == "FAIL":
